...
// Generated ut 25. júl 14:41:10 2023
...
function object2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._userdata.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-352 + w) + 'px';
				var h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-630 + h) + 'px';
			}
		}
		hs ='position:absolute;';
		hs+='left: -352px;';
		...
		this._description_fake=document.createElement('div');
		this._description_fake__text=document.createElement('div');
		this._description_fake.className='ggskin ggskin_textdiv';
		this._description_fake.ggTextDiv=this._description_fake__text;
		this._description_fake.ggId="description_fake";
		this._description_fake.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._description_fake.ggVisible=true;
		this._description_fake.className='ggskin ggskin_text';
		this._description_fake.ggType='text';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  140px;';
		hs+='width: 310px;';
		...
		hs+='visibility: inherit;';
		this._description_fake.setAttribute('style',hs);
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 310px;';
		...
		hs+='overflow: hidden;';
		this._description_fake__text.setAttribute('style',hs);
		this._description_fake.ggUpdateText=function() {
		...
		this._description_fake.ggUpdateText();
		this._description_fake.appendChild(this._description_fake__text);
		this._userdata.appendChild(this._description_fake);
		...
		this._datetime.ggUpdatePosition=function() {
			this.style[domTransition]='none';
			this.ggTextDiv.style.left=Math.floor(0 + (218-this.ggTextDiv.offsetWidth)*0) + 'px';
		}
		hs ='position:absolute;';
		hs+='left: 24px;';
		hs+='top:  72px;';
		...
		this._title.ggUpdateText=function() {
			var hs="<span style=\"font-family:SNGSans;font-size:20px;\">"+me.player.userdata.title+"<\/span>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
			}
